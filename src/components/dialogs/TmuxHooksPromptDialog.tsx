...
const TmuxHooksPromptDialog: React.FC<TmuxHooksPromptDialogProps> = memo(({ selectedIndex }) => {
  return (
      ...
      <Box flexDirection="column">
        ...
        <Box>
          {selectedIndex === 0 ? (
            ...
            <Text>{'  '}Yes, install hooks (recommended)</Text>
          )}
        </Box>
        ...
        <Box>
          {selectedIndex === 1 ? (
            ...
            <Text>{'  '}No, use polling instead</Text>
          )}
        </Box>
      </Box>
