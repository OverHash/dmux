  ...
  return `
    ...
    <table>
      <tbody>
        ...
        <tr><td><strong>Description</strong></td><td>Git only. Branch or ref to create new worktrees from. Leave empty to use the current HEAD. This can be a local branch like <code>main</code> or a remote-tracking ref like <code>origin/main</code>.</td></tr>
      </tbody>
    </table>
