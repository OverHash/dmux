...
process.stdin.on('end', () => {
  ...
  const event = {
    ...
    expectedDmuxPaneId: 'dmux-1776708264504',
  ...
  try {
    fs.writeFileSync('/Users/justinschroeder/Projects/dmux/.dmux/worktrees/dmux-slowness-codex/.codex/dmux/dmux-1776708264504.json', JSON.stringify(event, null, 2));
  } catch (error) {
    process.exit(0);
  }
